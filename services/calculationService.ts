...
import { Material, ProductRecipe, OrderUnit, CalculationResult, LayerSpec, MATERIAL_DENSITIES, MaterialType, ScrapBreakdown } from '../types';
...
export const calculateTheoreticalWebWeight = (
  ...
  const density = MATERIAL_DENSITIES[spec.type] || 0.91; // Fallback density
...
export const calculateRealMaterialWeight = (
    ...
    // Si el material tiene densidad específica guardada, usarla, sino usar la del tipo
    const density = material.density || MATERIAL_DENSITIES[material.type] || 0.91;
